...
# IoKruiseAppsV1alpha1DaemonSetStatus
...
**conditions** | [**List&lt;IoKruiseAppsV1alpha1DaemonSetStatusConditions&gt;**](IoKruiseAppsV1alpha1DaemonSetStatusConditions.md) | Represents the latest available observations of a DaemonSet&#39;s current state. |  [optional]
...
**daemonSetHash** | **String** | DaemonSetHash is the controller-revision-hash, which represents the latest version of the DaemonSet. | 
