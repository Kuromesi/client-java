 ...
 */
@ApiModel(description = "Lifecycle defines the lifecycle hooks for Pods pre-delete, in-place update. Currently, we only support pre-delete hook for Advanced DaemonSet.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-07-21T15:55:09.049+08:00")
public class KruiseAppsV1alpha1DaemonSetSpecLifecycle {
  ...
  public KruiseAppsV1alpha1DaemonSetSpecLifecycle inPlaceUpdate(KruiseAppsV1alpha1CloneSetSpecLifecycleInPlaceUpdate inPlaceUpdate) {
  ...
  **/
  ...
  public KruiseAppsV1alpha1DaemonSetSpecLifecycle preDelete(KruiseAppsV1alpha1CloneSetSpecLifecyclePreDelete preDelete) {
  ...
  **/
  ...
  public KruiseAppsV1alpha1DaemonSetSpecLifecycle preNormal(KruiseAppsV1alpha1CloneSetSpecLifecyclePreNormal preNormal) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    KruiseAppsV1alpha1DaemonSetSpecLifecycle ioKruiseAppsV1alpha1DaemonSetSpecLifecycle = (KruiseAppsV1alpha1DaemonSetSpecLifecycle) o;
    return Objects.equals(this.inPlaceUpdate, ioKruiseAppsV1alpha1DaemonSetSpecLifecycle.inPlaceUpdate) &&
        Objects.equals(this.preDelete, ioKruiseAppsV1alpha1DaemonSetSpecLifecycle.preDelete) &&
        Objects.equals(this.preNormal, ioKruiseAppsV1alpha1DaemonSetSpecLifecycle.preNormal);
  }
  ...
  public String toString() {
    ...
    sb.append("class KruiseAppsV1alpha1DaemonSetSpecLifecycle {\n");
